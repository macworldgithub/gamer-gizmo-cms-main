...
import AddStorageModal from "@/components/AddStoargeModal";
...
const StorageType = () => {
  ...
  const modelColumns = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <Popconfirm
          title="Are you sure you want to delete this Storage record?"
  ...
  const handleDeleteVariant = async (id) => {
    try {
      await axios.delete(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/storage/deleteStorage?id=${id}`,
...
export default dynamic(() => Promise.resolve(StorageType), { ssr: false });
